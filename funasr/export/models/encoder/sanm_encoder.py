...
from funasr.modules.embedding import StreamSinusoidalPositionEncoder, SinusoidalPositionEncoder
...
class SANMEncoderChunkOpt(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.embed = model.embed
        if isinstance(self.embed, StreamSinusoidalPositionEncoder) or isinstance(self.embed, SinusoidalPositionEncoder):
            self.embed = None
        self.model = model
        self.feats_dim = feats_dim
        self._output_size = model._output_size
